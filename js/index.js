  ...
  const projectData = {
    ...
    "젠틀몬스터 App Design": {
      ...
      buttons: [
        ...
        { label: "와이어프레임", href: "https://www.figma.com/design/sF6FEz1S4Vcdts2Ajoo2jK/%EC%A0%A0%ED%8B%80%EB%AA%AC%EC%8A%A4%ED%84%B0-App?node-id=0-1&t=KnG3XOPtasiXg7uR-1" },
        { label: "최종 프로젝트", href: "https://www.figma.com/design/sF6FEz1S4Vcdts2Ajoo2jK/%EC%A0%A0%ED%8B%80%EB%AA%AC%EC%8A%A4%ED%84%B0-App?node-id=80-8871&t=KnG3XOPtasiXg7uR-1" }
      ]
    },
    ...
    $mobileContents.each(function () {
      ...
      if ($phone.length) {
        ...
        optionNames.forEach(function (name, idx) {
          ...
          if (idx === 0) $li.addClass('active'); // 첫번째(JIWON's Portfolio) 활성
          $dropdown.append($li);
        });
